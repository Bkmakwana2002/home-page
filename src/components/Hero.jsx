...
const Hero = () => {
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white mt-40">AIR 2023</h1>
        <p className=" mb-8 text-xl font-normal text-black lg:text-4xl sm:px-16 xl:px-48">6th International Conference of The Robotics Society <br/>(5  – 8 July, 2023)</p>
