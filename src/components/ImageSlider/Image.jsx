...
const Image = () => {
  ...
  const images = [
	...
	const zoomInProperties = {
		...
		prevArrow: (
			<div>
				 <AiOutlineDoubleLeft className="text-4xl md:text-6xl md:mx-5 bg-blue-300 p-2 rounded-lg"/>
			</div>
		),
		nextArrow: (
			<div >
			<AiOutlineDoubleRight className="text-4xl md:text-6xl md:mx-5 bg-blue-300 p-2 rounded-lg"/>
			</div>
		),
	};
